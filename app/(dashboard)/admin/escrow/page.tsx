    ...
    return (
        <div className="space-y-8 animate-fade-in pb-12 text-[#1E293B]">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div className="px-6 py-4 bg-[#1E293B] rounded-[2rem] text-white shadow-2xl flex items-center gap-6 border border-[#10367D]/20">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
                <div className="xl:col-span-8 bg-white rounded-[3.5rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col">
                    <div className="p-10 border-b border-slate-50 flex items-center justify-between bg-slate-50/50">
                        ...
                        <div className="flex items-center gap-3">
                            {['All Funds', 'In Dispute', 'Pending Release'].map(f => (
                                <button key={f} className={`px-5 py-2 rounded-full text-[9px] font-black uppercase tracking-widest transition-all ${f === 'All Funds' ? 'bg-[#10367D] text-white' : 'bg-white border border-slate-100 text-slate-400'}`}>
                                    {f}
                                </button>
                            ))}
                        </div>
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {escrowFunds.map((fund) => (
                                    <tr key={fund.id} className="group hover:bg-slate-50/30 transition-all">
                                        ...
                                        <td className="px-10 py-8">
                                            <span className={`text-[9px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full border flex items-center gap-2 w-fit ${fund.status === 'HELD' ? 'bg-blue-50 text-blue-600 border-blue-100' :
                                        ...
                                        <td className="px-10 py-8 text-right">
                                            <button className="px-6 py-2.5 bg-[#1E293B] text-white text-[9px] font-black uppercase tracking-widest rounded-xl hover:scale-105 transition-all shadow-lg shadow-[#1E293B]/20">
                                                Manage Assets
                                            </button>
                                        </td>
                                    </tr>
                ...
                <div className="xl:col-span-4 space-y-8">
                    <div className="p-10 bg-[#1E293B] rounded-[3.5rem] text-white space-y-10 relative overflow-hidden group border border-[#10367D]/20 shadow-2xl">
                        ...
                        <div className="space-y-6">
                            <div className="p-8 bg-white/5 border border-white/10 rounded-2xl group-hover:border-blue-500/30 transition-all">
                                ...
                                <button className="mt-6 px-6 py-4 bg-[#10367D] text-white text-[9px] font-black uppercase tracking-[0.2em] rounded-2xl hover:scale-[1.02] transition-all w-full flex items-center justify-center gap-3">
                                    <FaUnlock className="w-3 h-3" /> Execute Release
                                </button>
                            </div>
                            <div className="p-8 bg-white/5 border border-white/10 rounded-2xl group-hover:border-rose-500/30 transition-all">
                                ...
                                <button className="mt-6 px-6 py-4 bg-rose-500 text-white text-[9px] font-black uppercase tracking-[0.2em] rounded-2xl hover:scale-[1.02] transition-all w-full flex items-center justify-center gap-3">
                    ...
                    <div className="p-10 bg-white border border-slate-100 rounded-[3.5rem] space-y-6">
                        ...
                        <div className="pt-4 p-6 bg-slate-50 rounded-2xl flex items-center gap-4">

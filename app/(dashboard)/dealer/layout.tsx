    ...
    return (
        <div className="flex min-h-screen bg-[#F8FAFC] text-[#1E293B] font-sans selection:bg-[#2772A0]/30 overflow-x-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
                <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#2772A0]/5 blur-[120px] rounded-full" />
                <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#2772A0]/5 blur-[120px] rounded-full" />
            </div>
            ...
            <div className="flex-1 flex flex-col min-w-0 relative z-10 w-full overflow-hidden">
                ...
                <header className="h-20 border-b border-[#2772A0]/10 bg-white/60 backdrop-blur-xl sticky top-0 z-30 flex items-center justify-between px-4 lg:px-8">
                    ...
                    <div className="flex items-center gap-3 lg:gap-6">
                        <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-[#2772A0]/10 text-[10px] font-bold tracking-widest text-[#2772A0] uppercase border border-[#2772A0]/20 rounded-full">
                        ...
                        <div className="hidden sm:block h-8 w-px bg-[#2772A0]/10 mx-2" />

                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-[#2772A0] flex items-center justify-center text-white font-black text-xs shadow-lg shadow-[#2772A0]/20">
                                DL
                            </div>
                        </div>
                    </div>

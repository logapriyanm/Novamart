    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    { label: 'Total Orders', value: '12', icon: ShoppingBag, color: 'text-[#10367D]' },
                    ...
                    <motion.div
                        ...
                        className="bg-white/60 backdrop-blur-md p-6 rounded-3xl border border-[#10367D]/10 flex items-center justify-between group hover:border-[#10367D]/30 transition-all"
                    >
                        <div>
                        ...
                        <div className={`w-12 h-12 rounded-2xl bg-white flex items-center justify-center shadow-lg border border-[#10367D]/5 transition-transform group-hover:scale-110 ${stat.color}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8">
                    <Card className="p-8">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <button className="flex items-center gap-2 text-[10px] font-black text-[#10367D] uppercase tracking-widest hover:underline">
                                View Full History
                        ...
                        <div className="space-y-4">
                            {recentOrders.map((order, i) => (
                                <div key={i} className="flex items-center justify-between p-4 rounded-2xl bg-[#EBEBEB]/50 hover:bg-white transition-all border border-transparent hover:border-[#10367D]/10 group">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center text-[#10367D] shadow-sm">
                                    ...
                                    <div className="text-right flex items-center gap-8">
                                        <p className="font-black text-[#10367D]">{order.price}</p>
                ...
                <div className="lg:col-span-4 space-y-6">
                    <Card className="p-8 bg-[#10367D] text-white">
                        ...
                        <button className="w-full mt-8 py-4 bg-white text-[#10367D] font-black text-xs uppercase tracking-widest rounded-2xl shadow-xl hover:scale-[1.02] transition-all flex items-center justify-center gap-2">
                            Manage Wallet
                    ...
                    <Card className="p-8">
                        <h4 className="text-[10px] font-black text-[#1E293B]/40 uppercase tracking-widest mb-6 py-1 border-b border-[#10367D]/10 flex items-center justify-between">
                            Shipping Profile
                        ...
                        <button className="w-full mt-6 py-3 bg-[#10367D]/5 text-[#10367D] font-black text-[10px] uppercase tracking-widest rounded-xl hover:bg-[#10367D] hover:text-white transition-all">
                            Change Destination
                        </button>
                    </Card>
                </div>

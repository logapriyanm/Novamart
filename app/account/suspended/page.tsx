...
export default function SuspendedPage() {
    return (
        <div className="min-h-screen flex items-center justify-center p-6 bg-[#EBEBEB]">
            <div className="max-w-md w-full bg-white rounded-[2rem] p-8 shadow-2xl shadow-[#10367D]/20 border border-rose-500/20 text-center animate-fade-in">
                ...
                <div className="mt-8 pt-6 border-t border-[#10367D]/10">
                    <p className="text-[10px] text-[#10367D]/40 font-bold uppercase tracking-widest">

            ...
            <div className="flex-1 space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
                    <div className="flex items-center gap-4">
                        <button className="bg-[#2772A0] text-white px-6 py-3 rounded-2xl font-bold flex items-center gap-2 shadow-xl shadow-[#2772A0]/20 active:scale-95 transition-all text-sm">
                            <Plus className="w-4 h-4" />
                            Add Product
                        </button>
                        <div className="flex p-1 bg-white/40 backdrop-blur-md border border-[#2772A0]/10 rounded-2xl">
                            <button className="p-2 rounded-xl bg-[#2772A0] text-white shadow-lg">
                                <Grid className="w-4 h-4" />
                            </button>
                            <button className="p-2 rounded-xl text-[#2772A0]/40 hover:text-[#2772A0] transition-colors">
                    ...
                    <div className="relative w-full sm:w-72">
                        <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#2772A0]/40" />
                        <input
                            type="text"
                            placeholder="Search Products..."
                            className="w-full bg-white/40 border border-[#2772A0]/10 rounded-2xl py-3 pl-12 pr-4 text-sm focus:outline-none focus:border-[#2772A0]/50 transition-all"
                        />
                    </div>
                </div>

                {/* Breadcrumbs Placeholder */}
                <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-[#2772A0]/40">
                    <span>Products</span>
                    <ChevronRight className="w-3 h-3" />
                    <span className="text-[#2772A0]">Product Grid</span>
                </div>

    ...
    <div className="mt-12">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-xl font-black text-slate-800 tracking-tight">
          Recently Saved for Later
        </h3>
        <button className="text-sm font-bold text-black hover:text-black/70 flex items-center gap-1">
        ...
        {savedItems.map((item) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <h4 className="font-black text-slate-800 text-sm mb-1 line-clamp-1">
                {item.name}
              </h4>
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="bg-black/5 text-black hover:bg-black hover:text-white px-6 py-3 rounded-xl text-sm font-bold transition-all"
              >
                Move to Cart
              </button>
            </div>

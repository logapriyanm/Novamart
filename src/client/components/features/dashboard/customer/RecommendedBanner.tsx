                ...
                <div className="max-w-lg space-y-6">
                    ...
                    <div className="flex gap-4 pt-4">
                        <div className="flex items-center gap-3 bg-white p-3 rounded-[10px] shadow-sm">
                            ...
                            <div>
                                <p className="text-sm font-bold text-[#1E293B]">Ergo Pro Mouse</p>
                                <p className="text-sm font-medium text-[#0F6CBD]">₹79.99</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 bg-white p-3 rounded-[10px] shadow-sm">
                            ...
                            <div>
                                <p className="text-sm font-bold text-[#1E293B]">Mechanical Keyboard</p>
                                <p className="text-sm font-medium text-[#0F6CBD]">₹129.99</p>
                            </div>
                        </div>
                    </div>
                </div>

    ...
    return (
        <div className="max-w-7xl mx-auto px-6 mt-12 mb-12">
            {categories.length > 0 ? (
                ...
                <div className="text-center py-20 bg-white rounded-[10px] border border-foreground/5">
                    <p className="text-[10px] font-black text-foreground/20 uppercase tracking-[0.2em]">No Active Categories Found</p>
                </div>
            )}
        </div>
    );

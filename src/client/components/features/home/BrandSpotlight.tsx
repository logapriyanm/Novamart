                    ...
                    >
                        ...
                        <div className="relative z-10 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                            <div className="bg-white/10 backdrop-blur-md border border-white/20 w-fit px-4 py-2 rounded-[10px] mb-4">
                                <span className="text-white font-semibold text-sm">{setup.name} collection</span>
                            </div>

                            <h3 className="text-2xl font-bold text-white mb-2">{setup.description}</h3>

                            <div className="flex items-center gap-2 text-white/80 text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-500">

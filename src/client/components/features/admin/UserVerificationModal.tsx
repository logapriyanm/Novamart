    ...
    return (
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
                ...
                >
                    <div className="bg-[#10367D] p-8 text-center text-white relative overflow-hidden">
                    ...
                    <div className="p-8 space-y-6">
                        ...
                        <div className="bg-amber-50 p-4 rounded-xl border border-amber-100 text-[10px] font-bold text-amber-700 leading-relaxed text-center">
                        ...
                        <div className="flex gap-4 pt-2">
                            <button
                                ...
                                disabled={isLoading}
                                className="flex-1 py-4 bg-rose-50 text-rose-600 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-rose-100 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                            >
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className="flex-1 py-4 bg-[#10367D] text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:shadow-lg hover:shadow-[#10367D]/20 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                            >

        ...
        <div className="space-y-8 animate-fade-in pb-12 text-slate-900">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-black tracking-tight">Sales <span className="text-[#067FF9]">Intel</span></h1>
                        <p className="text-slate-400 font-bold uppercase tracking-widest text-sm mt-1">Retail Performance & Demand Analytics</p>
                    </div>
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2 px-6 py-2 bg-white border border-slate-100 rounded-[10px] text-sm font-black text-slate-400 uppercase tracking-widest">
                            <FaCalendarAlt className="w-3 h-3 text-[#067FF9]" />
                            Last 30 Days
                        </div>
                        <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white rounded-[3.5rem] p-12 border border-slate-100 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="relative z-10 flex items-center justify-between mb-12">
                        <div>
                            <h2 className="text-sm font-black text-slate-900 uppercase tracking-widest">Revenue Momentum</h2>
                            <p className="text-xs font-black text-slate-400 uppercase tracking-widest mt-1 italic">Gross Value Transacted (Daily)</p>
                        </div>
                        <div className="text-right">
                            <p className="text-2xl font-black text-[#067FF9]">₹{(analytics.revenue || 0).toLocaleString()}</p>
                            <span className="text-xs font-black text-emerald-500 uppercase flex items-center gap-1 justify-end">
                ...
                <div className="space-y-8">
                    <div className="bg-slate-900 rounded-[3.5rem] p-10 text-white shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <h3 className="text-sm font-black uppercase tracking-[0.2em] text-slate-500 mb-2">Market Ranking</h3>
                            <p className="text-4xl font-black tracking-tight mb-2 italic">#{analytics.ranking || 'N/A'} <span className="text-[#067FF9] text-xl">Top Partner</span></p>
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-6">Based on SLA & Volume</p>
                        </div>
                    </div>
            ...
            <div className="p-10 bg-blue-50/50 rounded-[3.5rem] border border-[#067FF9]/10 flex flex-col md:flex-row items-center gap-12">
                ...
                <button className="px-8 py-4 bg-[#067FF9] text-white rounded-[10px] text-sm font-black uppercase tracking-widest shadow-xl shadow-[#067FF9]/20 hover:scale-105 transition-all">Download PDF Report</button>
            </div>
        </div>
    );
}

    ...
    return (
        <div className="min-h-screen bg-[#EBEBEB] flex items-center justify-center p-6">
            <div className="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[3rem] shadow-2xl overflow-hidden border border-slate-100">
                ...
                <div className="bg-slate-900 p-12 lg:p-16 text-white relative flex flex-col justify-between">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#067FF9]/20 to-transparent" />
                    <div className="relative z-10">
                        <div className="w-16 h-16 rounded-[10px] bg-[#067FF9] flex items-center justify-center mb-10 shadow-lg shadow-[#067FF9]/20">
                    ...
                    <div className="relative z-10 space-y-6 pt-12 border-t border-white/5">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-sm font-black uppercase tracking-widest">Documents Received</span>
                        </div>
                        <div className="flex items-center gap-4 opacity-50">
                            <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                                <span className="text-xs font-black">2</span>
                            </div>
                            <span className="text-sm font-black uppercase tracking-widest">Admin Review</span>
                        </div>
                        <div className="flex items-center gap-4 opacity-50">
                            <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                                <span className="text-xs font-black">3</span>
                            </div>
                            <span className="text-sm font-black uppercase tracking-widest">Batch ID Issued</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-12 lg:p-16 flex flex-col justify-center text-center">
                    ...
                    <h2 className="text-2xl font-black text-slate-900 mb-4 tracking-tight">Access Gate Locked</h2>
                    ...
                    <div className="space-y-4">
                        <Link href="/" className="flex items-center justify-center gap-2 w-full py-4 bg-[#067FF9] text-white rounded-[10px] font-black text-xs uppercase tracking-widest shadow-xl shadow-[#067FF9]/20 hover:scale-105 transition-all">
                            Explore Marketplace
                        </Link>
                        <Link href="/support" className="flex items-center justify-center gap-2 w-full py-4 bg-slate-50 text-slate-400 rounded-[10px] font-black text-xs uppercase tracking-widest hover:text-slate-900 transition-all">

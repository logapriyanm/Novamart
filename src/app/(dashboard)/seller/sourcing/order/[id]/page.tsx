            ...
            <div className="min-h-screen bg-[#EBEBEB] flex items-center justify-center p-6 animate-fade-in">
                ...
                >
                    ...
                    <p className="text-sm font-medium text-slate-400 mb-10 leading-relaxed">
                        ...
                        Stock will be added to your <span className="text-[#10367D] font-black">Seller Inventory</span> upon fulfillment.
                    </p>
    ...
    return (
        <div className="space-y-8 animate-fade-in pb-12 text-[#1E293B]">
            ...
            <div className="flex flex-col gap-2">
                <Link href="/dealer/sourcing" className="flex items-center gap-2 text-[10px] font-black text-[#10367D] uppercase tracking-widest hover:translate-x-[-4px] transition-transform">

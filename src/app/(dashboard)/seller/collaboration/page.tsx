            ...
            {loading ? (
                ...
                <div className="bg-white rounded-[30px] p-16 text-center border border-slate-100">
                    ...
                    <p className="text-slate-500 font-bold mb-8">
                        Create your first collaboration group to start pooling demand with other sellers
                    </p>
                    <button
                        onClick={() => router.push('/seller/collaboration/create')}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {groups.map((group, idx) => (
                        <motion.div
                            ...
                            onClick={() => router.push(`/seller/collaboration/${group._id}`)}
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                ...
                                <div className="bg-slate-50 rounded-[15px] p-4 border border-slate-100">
                                    ...
                                    <p className="text-sm font-black text-slate-800">{group.participantCount} sellers</p>
                                </div>
                            </div>

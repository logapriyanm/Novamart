                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-2">
                                                        ...
                                                        {!mfg.isVerified && mfg.user?.status !== 'SUSPENDED' && (
                                                            <span className="text-sm font-bold text-amber-600 bg-amber-50 px-2 py-1 rounded-[10px] border border-amber-100 flex items-center gap-1.5">
                        ...
                        {selectedRequest ? (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mb-10 relative">
                                    <div>
                                        <h1 className="text-2xl font-bold text-slate-900 tracking-tight uppercase italic">Manufacturer <span className="text-[#067FF9]">Registry</span></h1>

                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            {selectedRequest.isVerified ? (
                                                ...
                                                <button
                                                    ...
                                                    disabled={isVerifying}
                                                    className="group/btn relative py-5 bg-[#1212A1] hover:bg-[#0e0e81] text-white rounded-[10px] font-black text-sm shadow-2xl shadow-[#1212A1]/20 transition-all hover:-translate-y-1 active:scale-95 disabled:opacity-50 overflow-hidden"
                                                >

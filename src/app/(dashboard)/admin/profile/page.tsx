            ...
            <div className="bg-white rounded-[10px] p-8 border border-slate-100 shadow-sm max-w-2xl">
                <div className="flex items-center gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <span className="bg-slate-100 text-slate-600 px-3 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wide flex items-center gap-1.5 w-fit mt-2 border border-slate-200">

                ...
                <div className="col-span-4 bg-white rounded-[10px] border border-slate-100 shadow-sm flex flex-col overflow-hidden">
                    <div className="p-8 border-b border-slate-50 bg-slate-50/50">
                        <div className="relative">
                            ...
                            <input type="text" placeholder="PRIORITY FILTERS..." className="w-full bg-white border border-slate-200 rounded-[10px] py-3 pl-10 pr-4 text-[9px] font-black uppercase tracking-widest" />
                        </div>
                    </div>
                        ...
                        {mockEscalations.map((esc) => (
                            ...
                            >
                                <div className="flex justify-between items-start mb-2">
                                    <span className={`text-[8px] font-black px-2 py-0.5 rounded-[10px] border ${esc.priority === 'HIGH' ? 'bg-rose-100 text-rose-600 border-rose-200' : 'bg-amber-100 text-amber-600 border-amber-200'
                            ...
                            >
                                ...
                                <div className="p-8 border-b border-slate-50 flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <button
                                            onClick={freezeChat}
                                            className={`py-2.5 px-6 rounded-[10px] text-[9px] font-black uppercase tracking-widest transition-all flex items-center gap-2 ${isFrozen ? 'bg-amber-500 text-white' : 'bg-slate-100 text-slate-500 hover:bg-slate-200'
                                                }`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className="py-2.5 px-6 bg-emerald-500 text-white rounded-[10px] text-[9px] font-black uppercase tracking-widest hover:bg-emerald-600 shadow-lg shadow-emerald-500/20"
                                        >
                                            Resolve & Close
                                        </button>
                                    </div>
                                ...
                                <div className="p-10 border-t border-slate-50 bg-slate-50/30">
                                    <div className="flex items-center gap-6 bg-white border border-slate-200 rounded-[10px] p-3 pl-8">
                                        ...
                                        />
                                        <button className="py-4 px-10 bg-slate-900 text-white rounded-[10px] font-black text-[10px] uppercase tracking-widest shadow-xl">
                                            Log Decision
                                        </button>
                                    </div>
                                </div>

...
export default function VerificationCenter() {
    ...
    return (
        <div className="space-y-8 animate-fade-in pb-12">
            ...
            {users.length === 0 ? (
                <div className="p-12 text-center bg-white rounded-3xl border border-slate-100 text-slate-400 font-bold">
                    No pending verifications.
                </div>
            ) : (
                <div className="grid grid-cols-1 gap-6">
                    {users.map(user => (
                        <div key={user.id} className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                            <div className="flex items-center gap-4 mb-4 border-b border-slate-50 pb-4">
                                ...
                                <span className="ml-auto px-3 py-1 bg-amber-50 text-amber-600 rounded-lg text-[10px] font-black uppercase tracking-widest">
                                    Pending Review
                                </span>
                            </div>
                                    ...
                                    <div key={doc.id} className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                ...
                                                className="p-2 bg-emerald-500 text-white rounded-lg shadow-lg shadow-emerald-500/20 hover:bg-emerald-600 transition-colors"
                                                title="Approve"
                                            >
                                                <FaCheck />
                                            </button>

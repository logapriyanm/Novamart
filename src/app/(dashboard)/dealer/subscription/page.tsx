    ...
    return (
        <div className="space-y-8 animate-fade-in pb-20">
            <div className="text-center max-w-2xl mx-auto">
                ...
                <p className="text-sm font-bold text-slate-500">Tiered growth plans designed for high-performing dealers. Unlock wholesale discounts, prioritized stock, and boosted retail margins.</p>
            </div>

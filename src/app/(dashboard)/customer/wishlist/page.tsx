  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-7xl mx-auto pb-12">
      ...
      {loading ? (
        ...
        <Card className="p-12 border-none shadow-xl bg-white rounded-[20px] text-center space-y-4">
          ...
          <Link
            href="/products"
            className="inline-block mt-4 px-6 py-2 bg-black text-white text-sm font-bold tracking-widest rounded-lg hover:bg-slate-800 transition-all"
          >
            Browse Products
          </Link>
        </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {wishlist.map((product) => (
            <div
              key={product.id}
              className="bg-white p-4 rounded-[20px] border border-slate-100 shadow-sm hover:shadow-md transition-all group"
            >

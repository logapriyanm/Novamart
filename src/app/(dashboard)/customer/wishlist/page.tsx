...
export default function WishlistPage() {
    ...
    return (
        <div className="space-y-8 animate-fade-in max-w-7xl mx-auto pb-12">
            <h1 className="text-3xl font-black text-slate-800 tracking-tight italic uppercase">My Wishlist</h1>
            ...
            {loading ? (
                ...
                <Card className="p-12 border-none shadow-xl shadow-blue-600/5 bg-white rounded-[20px] text-center space-y-4">
                    ...
                    <Link href="/products" className="inline-block mt-4 px-6 py-2 bg-black text-white text-sm font-bold tracking-widest rounded-lg hover:bg-slate-800 transition-all">
                        Browse Products
                    </Link>
                </Card>
            ) : (

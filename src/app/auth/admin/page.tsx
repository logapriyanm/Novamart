...
import { FaShieldAlt, FaLock, FaKey, FaArrowRight, FaClock } from 'react-icons/fa';
                        ...
                        {step === 1 ? (
                            ...
                            >
                                <div className="text-center text-slate-400 space-y-2">
                                    ...
                                    <p className="text-[10px] font-bold uppercase tracking-widest text-[#10367D]">Check Governance Email for OTP</p>
                                </div>

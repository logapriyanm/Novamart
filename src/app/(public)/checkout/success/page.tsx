            ...
            <div className="max-w-[1000px] w-full px-6">
                ...
                <div className="text-center space-y-4 mb-10">
                    <motion.div
                        ...
                        className="w-24 h-24 bg-emerald-500 rounded-[10px] flex items-center justify-center text-white mx-auto shadow-2xl shadow-emerald-500/30"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="bg-white rounded-[10px] p-10 lg:p-12 border border-foreground/[0.03] shadow-xl shadow-foreground/[0.02]">
                        <h3 className="text-lg font-black text-foreground mb-10 tracking-tight uppercase italic">Order <span className="text-black">Journey</span></h3>
                    ...
                    <div className="space-y-8">
                        {/* Escrow Status Box */}
                        <div className="bg-black text-white rounded-[10px] p-10 shadow-2xl shadow-black/20 relative overflow-hidden group">
                ...
                <div className="mt-16 text-center">
                    <Link href="/customer">
                        <button className="bg-black text-white px-12 py-6 rounded-[10px] font-black text-xs uppercase tracking-[0.3em] hover:scale-105 transition-all shadow-2xl shadow-black/20 flex items-center gap-4 mx-auto">
                            Go to My Orders
                            <HiOutlineArrowRight className="w-4 h-4" />
                        </button>
                    </Link>

...
export default function ProductDetailPage() {
    ...
    const handleAction = (action: 'cart' | 'buy') => {
        ...
        alert(`${action === 'cart' ? 'Added to Cart' : 'Proceeding to Buy'} ${quantity} units!`);
    };
                        ...
                        <div className="mb-10">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <button
                                    ...
                                    className="w-full py-5 bg-white border-2 border-[#10367D] text-[#10367D] font-black text-sm rounded-2xl shadow-xl shadow-[#10367D]/5 hover:bg-[#10367D]/5 transition-all uppercase tracking-widest flex items-center justify-center gap-3"
                                >
                                ...
                                <button
                                    ...
                                    className="w-full py-5 bg-[#10367D] text-white font-black text-sm rounded-2xl shadow-xl shadow-[#10367D]/20 hover:scale-[1.02] transition-all uppercase tracking-widest flex items-center justify-center gap-3"
                                >

                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
                            {contactMethods.map((method, i) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-sm font-black text-foreground/40 tracking-widest mb-2">{method.title}</h3>
                        ...
                        <div className="bg-black p-10 rounded-[10px] text-white overflow-hidden relative group">
                            ...
                            <h3 className="text-sm font-black tracking-widest mb-8 relative z-10 opacity-40 italic">Follow Progress</h3>
                    ...
                    >
                        <form className="space-y-8">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    <label className="text-sm font-black text-black/40 tracking-widest ml-1">Full Name</label>
                                    <input
                                        type="text"
                                ...
                                <div className="space-y-3">
                                    <label className="text-sm font-black text-black/40 tracking-widest ml-1">Email Address</label>
                                    <input
                                        type="email"
                            ...
                            <div className="space-y-3">
                                <label className="text-sm font-black text-black/40 tracking-widest ml-1">Subject</label>
                            ...
                            <div className="space-y-3">
                                <label className="text-sm font-black text-black/40 tracking-widest ml-1">Your Message</label>
                                <textarea
                                    rows={5}
                        ...
                        <div className="mt-12 flex items-center gap-4 text-sm font-bold text-[#1E293B]/40 uppercase tracking-widest justify-center">
